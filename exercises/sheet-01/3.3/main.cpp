...
double calculate_sqrt(double number, double precision, unsigned int max_iterations) {
    double rq = 1;
...
int main(int, char**) {
    ...
    cout.precision(8);
    cout << "The square root of " << number << " is aproximately " << calculate_sqrt(number, precision, max_iterations) << endl;
}
